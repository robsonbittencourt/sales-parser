...
public class WorseSalesmanTest {

    @Test
    public void shouldReturnCorrectDescription() {
        String description = new WorseSalesman().description();
    ...
    public void shouldReturnCorrectDataType() {
        Class<?> clazz = new WorseSalesman().dataType();

        assertEquals(Sale.class, clazz);
    }

    @Test
    public void shouldReturnEmptyStringWhenDoesNotHaveWorseSalesman() {
        ReportItem reportItem = new WorseSalesman();
    ...
    public void shouldCountCustomerWhenProcess() {
        ...
        assertEquals("Andrea", reportItem.value());
    }
